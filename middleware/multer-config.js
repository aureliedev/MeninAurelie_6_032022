...
/* Création de la configuration de MULTER */
const storage = multer.diskStorage({
    /* Définit le dossier d'images comme destination */
    ...
    filename: (req, file, callback) => {
        ...
        /* Génération de l'extension en choisissant dans le dictionnaire MIME_TYPE qui correspond au mimetype du fichier. */
